...
def pretrain_process(chunk_size=50000):
    ...
    with jsonlines.open('./datasets/mobvoi_seq_monkey_general_open_corpus.jsonl') as reader:
        with open('./datasets/pretrain_data.csv', 'w', newline='', encoding='utf-8') as csvfile:
